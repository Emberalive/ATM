...
public class Bank
{
    ...
    public Bank()
    {
        ...
        BankAccount account = new BankAccount(01, 1234, 500);
    ...
    { 
        ...
        for (BankAccount a: accounts) {
             Integer currentAccountNumber = a.accNumber;
             Integer currentPassword = a.accPasswd;
             if (currentAccountNumber.equals(newAccNumber) && currentPassword.equals(newAccPasswd)) {
                    account = a;
                    Debug.trace("Bank::login: Found matching account with number: " + currentAccountNumber);
                    return true;
                 }
             return false;
        }
    ...
    public int getBalance() 
    {
        ...
        public int changePassword (int newPasswd){
        account.accPasswd = newPasswd;
        return account.accPasswd;
    }
