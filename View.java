...
class View
{
    int H = 460;         // Height of window pixels 
    ...
    public void start(Stage window)
    {
        ...
        String labels[][] = {
                ...
                {"",  "0",  "",   "",  "acc",     "No"} };
        /**
        *For some reason the action buttons (on the left hand side) are not working with the CSS sheet and they appear as ... 
        *instead of the characters that they should be. this has meant that I have had to change
        *the characters so that they are actually visible
        */
